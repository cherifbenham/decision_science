...
class Seller:
    ...
    def get_review_score(self):
        ...
        # Rename columns
        res.columns = [
            'seller_id', 'share_of_one_stars', 'share_of_two_stars', 'share_of_three_stars', 'share_of_five_stars',
            'review_score'
        ]
    ...
    def get_training_data(self):
        ...
        'wait_time', 'date_first_sale', 'date_last_sale', 'months_on_olist', 'share_of_one_stars', 'share_of_two_stars', 'share_of_three_stars',
